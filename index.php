    ...
    <section class="featured">
        <div class="container featured__container">
            ...
            <div class="post__info">
                <?php
                    //fetch category from categories table using category_id of a post
                ...
                ?>
                <a href="<?= ROOT_URL ?>category-post.php?id=<?= $featured['category_id'] ?>" class="category__button"><?= $category_title ?></a>
                <h2 class="post_title">

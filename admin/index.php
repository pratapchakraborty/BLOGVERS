<?php
    ...
    //fetch current user post from the database
...
<?php if(isset($_SESSION['add-post-success'])) : //show if add post was successful ?>
            ...
            <?php elseif(isset($_SESSION['delete-post-success'])) : //show if edit post was not successful ?>
            <div class="alert__message success container">
                <p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id'] ?>" class="btn danger sm">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile ?>
                </tbody>

...
<section class="dashboard">
        <?php if(isset($_SESSION['add-user-success'])) : //show if add user was successful ?>
            ...
            <?php elseif(isset($_SESSION['edit-user'])) : //show if edit user was not set ?>
            ...
            <?php elseif(isset($_SESSION['delete-user-success'])) : //show if delete user was not set ?>
            <div class="alert__message success container">
                <p>
            ...
            <?php elseif(isset($_SESSION['delete-user'])) : //show if delete user was set ?>
            <div class="alert__message error container">
                <p>
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="<?= ROOT_URL ?>admin/manage-users.php" class="active"><i class="uil uil-users-alt"></i>
                    <h5>Manage Users</h5>
                </a></li>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= ROOT_URL ?>admin/delete-user.php?id=<?= $user['id']?>" class="btn danger sm">Delete</a>
                        </td>

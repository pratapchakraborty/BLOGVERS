...
<?php if(isset($_SESSION['add-category-success'])) : //show if add category was successful ?>
            ...
            <?php elseif(isset($_SESSION['add-category'])) : //show if add category was successful ?>
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="<?= ROOT_URL ?>admin/manage-categories.php" class="active"><i class="uil uil-list-ul"></i>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= ROOT_URL ?>admin/delete-category.php?id=<?= $category['id'] ?>" class="btn danger sm">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile ?>
                </tbody>
